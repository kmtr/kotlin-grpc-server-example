...
import kt.hello.proto.GreeterGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for kt.hello.proto.Greeter.
 */
object GreeterGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) kt.hello.proto.Greeter service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the kt.hello.proto.Greeter service based on Kotlin coroutines.
   */
  abstract class GreeterCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for kt.hello.proto.Greeter.SayHello.
     *
    ...
    open suspend fun sayHello(request: HelloRequest): HelloReply = throw
        StatusException(UNIMPLEMENTED.withDescription("Method kt.hello.proto.Greeter.SayHello is unimplemented"))
